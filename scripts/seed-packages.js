...
const SAMPLE_PACKAGES = [
  ...
  {
    package_name: 'Hubli to Gokarna Round Trip Package',
    tour_type: 'Round Trip Package',
    route: 'Hubli - Gokarna - Hubli',
    duration: '2 Nights / 3 Days',
    image_url: '',
    rating: 4.5,
    display_order: 8,
    pricing_rows: [
      ...
      { vehicle_type: '7+1 Seater (Innova)', price_range: '₹19,500' },
      { vehicle_type: '13+1 Seater (Tempo Traveller)', price_range: '₹18,200 - ₹25,200' },
      { vehicle_type: '21+1 Mini Bus (AC)', price_range: '₹29,500 - ₹38,500' },
      { vehicle_type: '25+1 Mini Bus (AC)', price_range: '₹50,500' },
      { vehicle_type: '29+1 Mini Bus (AC)', price_range: '₹59,900' },
    ],
  },
  {
    package_name: 'Hubli to Dharmasthala Round Trip Package',
    tour_type: 'Round Trip Package',
    route: 'Hubli - Dharmasthala - Hubli',
    duration: '3 Nights / 4 Days',
    image_url: '',
    rating: 4.6,
    display_order: 9,
    pricing_rows: [
      { vehicle_type: '4+1 Seater', price_range: '₹17,400 - ₹24,000' },
      { vehicle_type: '6+1 Seater (Ertiga)', price_range: '₹21,000 - ₹28,000' },
      { vehicle_type: '7+1 Seater (Innova)', price_range: '₹31,500' },
      { vehicle_type: '13+1 Seater (Tempo Traveller)', price_range: '₹25,200 - ₹37,000' },
      { vehicle_type: '21+1 Seater (Mini Bus)', price_range: '₹39,600 - ₹59,000' },
      { vehicle_type: '25+1 Seater (Mini Bus)', price_range: '₹70,800' },
      { vehicle_type: '29+1 Seater (Mini Bus)', price_range: '₹81,800' },
    ],
  },
  {
    package_name: 'Hubli to Murudeshwar Round Trip Package',
    tour_type: 'Round Trip Package',
    route: 'Hubli - Murudeshwar - Hubli',
    duration: '2 Nights / 3 Days',
    image_url: '',
    rating: 4.5,
    display_order: 10,
    pricing_rows: [
      { vehicle_type: '4+1 Seater', price_range: '₹12,200 - ₹12,600' },
      { vehicle_type: '6+1 Seater', price_range: '₹15,000' },
      { vehicle_type: '7+1 Seater (Innova)', price_range: '₹19,500' },
      { vehicle_type: '13+1 Seater (Tempo Traveller)', price_range: '₹18,200 - ₹25,200' },
      { vehicle_type: '21+1 Seater (Mini Bus)', price_range: '₹39,600 - ₹59,000' },
      { vehicle_type: '25+1 Seater (Mini Bus)', price_range: '₹70,800' },
  ...
  {
    package_name: 'Hubli to Dandeli Round Trip Package',
    tour_type: 'Round Trip Package',
    route: 'Hubli - Dandeli - Hubli',
    duration: '2 Nights / 3 Days',
    image_url: '',
    rating: 4.5,
    display_order: 11,
